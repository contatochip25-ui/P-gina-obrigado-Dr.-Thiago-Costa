  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="p-6 bg-slate-900/30 border border-slate-800 rounded-2xl flex flex-col items-center text-center space-y-2">
        ...
        <span className="text-slate-100 font-semibold text-lg">18 de Janeiro, 2025</span>
      </div>
      ...
      <div className="p-6 bg-slate-900/30 border border-slate-800 rounded-2xl flex flex-col items-center text-center space-y-2">
        ...
        <span className="text-slate-100 font-semibold text-lg">20h (Horário de Brasília)</span>
      </div>
      ...
      <div className="p-6 bg-slate-900/30 border border-slate-800 rounded-2xl flex flex-col items-center text-center space-y-2">
        ...
        <span className="text-slate-100 font-semibold text-lg">Online e Ao Vivo</span>
      </div>
    </div>
  );
};
